...
(() => {
  ...
  data.pdfPracticeSets = [
    { id: "pdf-basic-rules-1-1", sectionId: meta.basic.sectionId, title: "Basic Integral Rules 1", subtitle: "Imported worksheet practice for Chapter 5 standard forms", pdfLabel: "Source: Basic Integral Rules worksheet (set 1)", icon: "functions", accentBg: "bg-sky-100 dark:bg-sky-900/30", accentText: "text-sky-600 dark:text-sky-300", buttonClass: "bg-sky-500 hover:bg-sky-600 shadow-[0_3px_0_0_#1d4ed8]", itemIds: [...ids.basic] },
    { id: "pdf-basic-rules-scan", sectionId: meta.basic.sectionId, title: "Basic Integral Rules 2", subtitle: "Matched to the alternate worksheet copy", pdfLabel: "Source: Basic Integral Rules worksheet (set 2)", icon: "calculate", accentBg: "bg-cyan-100 dark:bg-cyan-900/30", accentText: "text-cyan-600 dark:text-cyan-300", buttonClass: "bg-cyan-500 hover:bg-cyan-600 shadow-[0_3px_0_0_#0f766e]", itemIds: [...ids.basic] },
    { id: "pdf-u-sub-scan", sectionId: meta.uSub.sectionId, title: "Integration Using u-Substitution", subtitle: "Matched to the readable substitution worksheet set", pdfLabel: "Source: Integration Using u-Substitution worksheet", icon: "route", accentBg: "bg-amber-100 dark:bg-amber-900/30", accentText: "text-amber-600 dark:text-amber-300", buttonClass: "bg-amber-500 hover:bg-amber-600 shadow-[0_3px_0_0_#b45309]", itemIds: [...ids.uSub] },
    { id: "pdf-u-sub-1-2", sectionId: meta.uSub.sectionId, title: "Change of Variable Method", subtitle: "Imported worksheet practice for substitution drills", pdfLabel: "Source: Change of Variable Method worksheet", icon: "swap_horiz", accentBg: "bg-emerald-100 dark:bg-emerald-900/30", accentText: "text-emerald-600 dark:text-emerald-300", buttonClass: "bg-emerald-500 hover:bg-emerald-600 shadow-[0_3px_0_0_#047857]", itemIds: [...ids.uSub] },
    { id: "pdf-trig-scan", sectionId: meta.trig.sectionId, title: "Trigonometric Substitution", subtitle: "Focused trig-only drill set matched from the readable worksheet", pdfLabel: "Source: Trigonometric Substitution worksheet", icon: "waves", accentBg: "bg-violet-100 dark:bg-violet-900/30", accentText: "text-violet-600 dark:text-violet-300", buttonClass: "bg-violet-500 hover:bg-violet-600 shadow-[0_3px_0_0_#6d28d9]", itemIds: trigOnlyAliasIds },
    { id: "pdf-trig-hyperbolic-3-1", sectionId: meta.trig.sectionId, title: "Trigonometric and Hyperbolic Substitution", subtitle: "Imported worksheet practice for trig and hyperbolic substitution", pdfLabel: "Source: Trigonometric and Hyperbolic Substitution worksheet", icon: "orbit", accentBg: "bg-fuchsia-100 dark:bg-fuchsia-900/30", accentText: "text-fuchsia-600 dark:text-fuchsia-300", buttonClass: "bg-fuchsia-500 hover:bg-fuchsia-600 shadow-[0_3px_0_0_#a21caf]", itemIds: [...ids.trig] },
  ];
})();
