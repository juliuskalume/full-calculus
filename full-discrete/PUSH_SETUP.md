...
Choose your `full-discrete` Firebase project.
...
Create `functions/.env.full-discrete` from `functions/.env.example` and fill values:
...
```
https://us-central1-full-discrete.cloudfunctions.net/sendTestPush?uid=YOUR_UID&key=CHANGE_ME
```
